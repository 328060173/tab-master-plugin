<template>
  <div class="relative shrink-0 inline-flex"
    ...
    <div :class="['flex items-center justify-center rounded-lg bg-gray-100 text-gray-600 font-bold overflow-hidden w-full h-full',
      ...
      <img v-if="isRenderableImgSrc(src) && !failed" :src="src" class="w-full h-full object-contain" @error="failed = true" />
...
import { isRenderableImgSrc } from "~lib/external-resource"
