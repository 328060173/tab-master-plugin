...
// 2026-08-22：15→16（ASO 商店名/描述/关键词重写：商店名前置品类词、slogan 改「下班敢关+一键恢复」、关键词改品类+痛点双覆盖、详细描述重写）。
...
// 2026-08-22：1.4.1→1.4.2（ASO 文案重写：商店名/短描述/详细描述/关键词四件套更新，非功能变更故升 patch）。
export const APP_VERSION_NAME = "1.4.2"
