> 来源: https://developer.chrome.com/docs/extensions/reference/api/dns
...
# chrome.dns <span slot="popout-heading"> Stay organized with collections </span> <span slot="popout-contents"> Save and categorize content based on your preferences. </span>
...
- <div>
  ...
  <div id="property-ResolveCallbackResolveInfo-address" class="dcc-code-sections__label">
...
- <div>
  ...
  <div id="property-ResolveCallbackResolveInfo-resultCode" class="dcc-code-sections__label">
...
- <div>
  ...
  <div id="type-resolve-hostname" class="dcc-code-sections__label">
