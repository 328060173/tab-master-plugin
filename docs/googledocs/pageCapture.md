> 来源: https://developer.chrome.com/docs/extensions/reference/api/pageCapture
...
# chrome.pageCapture <span slot="popout-heading"> Stay organized with collections </span> <span slot="popout-contents"> Save and categorize content based on your preferences. </span>
...
- <div>
  ...
  <div id="type-saveAsMHTML-details" class="dcc-code-sections__label">
  ...
  - <div>
    ...
    <div id="property-saveAsMHTML-details-tabId" class="dcc-code-sections__label">
