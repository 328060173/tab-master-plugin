> 来源: https://developer.chrome.com/docs/extensions/reference/api/sessions
...
# chrome.sessions <span slot="popout-heading"> Stay organized with collections </span> <span slot="popout-contents"> Save and categorize content based on your preferences. </span>
...
- <div>
  ...
  <div id="property-Device-deviceName" class="dcc-code-sections__label">
...
- <div>
  ...
  <div id="property-Device-sessions" class="dcc-code-sections__label">
...
- <div>
  ...
  <div id="property-Filter-maxResults" class="dcc-code-sections__label">
...
- <div>
  ...
  <div id="property-Session-lastModified" class="dcc-code-sections__label">
...
- <div>
  ...
  <div id="property-Session-tab" class="dcc-code-sections__label">
...
- <div>
  ...
  <div id="property-Session-window" class="dcc-code-sections__label">
  ...
  [Window](https://developer.chrome.com/docs/extensions/reference/windows/#type-Window) <span class="dcc-code-sections__optional">optional</span>
...
<span class="dcc-code-sections__value">25</span>\
...
- <div>
  ...
  [Filter](#type-Filter) <span class="dcc-code-sections__optional">optional</span>
...
- <div>
  ...
  <div id="type-getRecentlyClosed-filter" class="dcc-code-sections__label">
...
- <div>
  ...
  <div id="type-restore-sessionId" class="dcc-code-sections__label">
