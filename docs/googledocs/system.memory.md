> 来源: https://developer.chrome.com/docs/extensions/reference/api/system/memory
...
# chrome.system.memory <span slot="popout-heading"> Stay organized with collections </span> <span slot="popout-contents"> Save and categorize content based on your preferences. </span>
...
- <div>
  ...
  <div id="property-MemoryInfo-availableCapacity" class="dcc-code-sections__label">
...
- <div>
  ...
  <div id="property-MemoryInfo-capacity" class="dcc-code-sections__label">
