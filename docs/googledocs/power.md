> 来源: https://developer.chrome.com/docs/extensions/reference/api/power
...
# chrome.power <span slot="popout-heading"> Stay organized with collections </span> <span slot="popout-contents"> Save and categorize content based on your preferences. </span>
...
<span class="dcc-type--xsmall" style="white-space: initial">Prevents the system from sleeping in response to user inactivity.</span>

<span style="white-space: nowrap;"></span>

<span class="dcc-code-sections__value">"display"</span>\
<span class="dcc-type--xsmall" style="white-space: initial">Prevents the display from being turned off or dimmed, or the system from sleeping in response to user inactivity.</span>
...
<span class="dcc-tag-pill--blue dcc-tag-pill" title="Available from this Chrome version and higher">Chrome 113+ </span><span class="dcc-tag-pill--pink dcc-tag-pill"> ChromeOS only </span>
...
- <div>
  ...
  <div id="type-requestKeepAwake-level" class="dcc-code-sections__label">
