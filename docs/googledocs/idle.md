> 来源: https://developer.chrome.com/docs/extensions/reference/api/idle
...
# chrome.idle <span slot="popout-heading"> Stay organized with collections </span> <span slot="popout-contents"> Save and categorize content based on your preferences. </span>
...
<span class="dcc-code-sections__value">"idle"</span>\
<span class="dcc-type--xsmall" style="white-space: initial"></span>

<span style="white-space: nowrap;"></span>

<span class="dcc-code-sections__value">"locked"</span>\
<span class="dcc-type--xsmall" style="white-space: initial"></span>
...
<span class="dcc-tag-pill--blue dcc-tag-pill" title="Available from this Chrome version and higher">Chrome 73+ </span><span class="dcc-tag-pill--pink dcc-tag-pill"> ChromeOS only </span>
...
- <div>
  ...
  <div id="type-queryState-detectionIntervalInSeconds" class="dcc-code-sections__label">
...
- <div>
  ...
  <div id="type-setDetectionInterval-intervalInSeconds" class="dcc-code-sections__label">
...
- <div>
  ...
  <div id="method-onStateChanged-callback" class="dcc-code-sections__label">
  ...
  - <div>
    ...
    <div id="type-onStateChanged-callback-newState" class="dcc-code-sections__label">
