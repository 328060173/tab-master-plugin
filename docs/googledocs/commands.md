> 来源: https://developer.chrome.com/docs/extensions/reference/api/commands
...
# chrome.commands <span slot="popout-heading"> Stay organized with collections </span> <span slot="popout-contents"> Save and categorize content based on your preferences. </span>
...
- <div>
  ...
  <div id="property-Command-description" class="dcc-code-sections__label">
...
- <div>
  ...
  <div id="property-Command-name" class="dcc-code-sections__label">
...
- <div>
  ...
  <div id="property-Command-shortcut" class="dcc-code-sections__label">
...
- <div>
  ...
  <div id="method-onCommand-callback" class="dcc-code-sections__label">
  ...
  - <div>
    ...
    <div id="type-onCommand-callback-command" class="dcc-code-sections__label">
  ...
  - <div>
    ...
    <div id="type-onCommand-callback-tab" class="dcc-code-sections__label">
