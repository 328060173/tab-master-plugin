> 来源: https://developer.chrome.com/docs/extensions/reference/api/dom
...
# chrome.dom <span slot="popout-heading"> Stay organized with collections </span> <span slot="popout-contents"> Save and categorize content based on your preferences. </span>
...
- <div>
  ...
  <div id="type-openOrClosedShadowRoot-element" class="dcc-code-sections__label">
