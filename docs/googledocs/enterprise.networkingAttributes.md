> 来源: https://developer.chrome.com/docs/extensions/reference/api/enterprise/networkingAttributes
...
# chrome.enterprise.networkingAttributes <span slot="popout-heading"> Stay organized with collections </span> <span slot="popout-contents"> Save and categorize content based on your preferences. </span>
...
- <div>
  ...
  <div id="property-NetworkDetails-ipv4" class="dcc-code-sections__label">
...
- <div>
  ...
  <div id="property-NetworkDetails-ipv6" class="dcc-code-sections__label">
...
- <div>
  ...
  <div id="property-NetworkDetails-macAddress" class="dcc-code-sections__label">
