> 来源: https://developer.chrome.com/docs/extensions/reference/api/system/cpu
...
# chrome.system.cpu <span slot="popout-heading"> Stay organized with collections </span> <span slot="popout-contents"> Save and categorize content based on your preferences. </span>
...
- <div>
  ...
  <div id="property-CpuInfo-archName" class="dcc-code-sections__label">
...
- <div>
  ...
  <div id="property-CpuInfo-features" class="dcc-code-sections__label">
...
- <div>
  ...
  <div id="property-CpuInfo-modelName" class="dcc-code-sections__label">
...
- <div>
  ...
  <div id="property-CpuInfo-numOfProcessors" class="dcc-code-sections__label">
...
- <div>
  ...
  <div id="property-CpuInfo-processors" class="dcc-code-sections__label">
...
- <div>
  ...
  <div id="property-CpuInfo-temperatures" class="dcc-code-sections__label">
  ...
  <span class="dcc-tag-pill--blue dcc-tag-pill" title="Available from this Chrome version and higher">Chrome 60+ </span>
...
- <div>
  ...
  <div id="property-CpuTime-idle" class="dcc-code-sections__label">
...
- <div>
  ...
  <div id="property-CpuTime-kernel" class="dcc-code-sections__label">
...
- <div>
  ...
  <div id="property-CpuTime-total" class="dcc-code-sections__label">
...
- <div>
  ...
  <div id="property-CpuTime-user" class="dcc-code-sections__label">
...
- <div>
  ...
  <div id="property-ProcessorInfo-usage" class="dcc-code-sections__label">
