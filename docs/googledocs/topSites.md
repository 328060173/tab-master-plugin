> 来源: https://developer.chrome.com/docs/extensions/reference/api/topSites
...
# chrome.topSites <span slot="popout-heading"> Stay organized with collections </span> <span slot="popout-contents"> Save and categorize content based on your preferences. </span>
...
- <div>
  ...
  <div id="property-MostVisitedURL-title" class="dcc-code-sections__label">
...
- <div>
  ...
  <div id="property-MostVisitedURL-url" class="dcc-code-sections__label">
