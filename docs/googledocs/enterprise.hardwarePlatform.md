> 来源: https://developer.chrome.com/docs/extensions/reference/api/enterprise/hardwarePlatform
...
# chrome.enterprise.hardwarePlatform <span slot="popout-heading"> Stay organized with collections </span> <span slot="popout-contents"> Save and categorize content based on your preferences. </span>
...
- <div>
  ...
  <div id="property-HardwarePlatformInfo-manufacturer" class="dcc-code-sections__label">
...
- <div>
  ...
  <div id="property-HardwarePlatformInfo-model" class="dcc-code-sections__label">
